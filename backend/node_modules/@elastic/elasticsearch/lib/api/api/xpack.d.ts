...
export default class Xpack {
    ...
    /**
      ...
      * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.16/info-api.html | Elasticsearch API documentation}
      */
    ...
    /**
      ...
      * @see {@link https://www.elastic.co/guide/en/elasticsearch/reference/8.16/usage-api.html | Elasticsearch API documentation}
      */
